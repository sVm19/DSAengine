...
#[macros::mcp_tool(
    name = "arrays_strings.dutch_national_flag",
    description = "Use this for solving dutch national flag problems. Trigger Keywords: dutch_national_flag, dutch national flag, algorithm, dsa. Input Hints: Look for input fields like nums, numbers, arr, target, edges, adj, source, capacity, weight, values in the user's text to populate task arguments.. Why: Choose this over generic fallback when the problem domain matches the algorithm's strengths for best-performance results."
)]

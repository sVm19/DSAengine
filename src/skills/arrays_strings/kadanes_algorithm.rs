...
#[macros::mcp_tool(
    name = "arrays_strings.kadanes_algorithm",
    description = "Use this for solving kadanes algorithm problems. Trigger Keywords: kadanes_algorithm, kadanes algorithm, algorithm, dsa. Input Hints: Look for input fields like nums, numbers, arr, target, edges, adj, source, capacity, weight, values in the user's text to populate task arguments.. Why: Choose this over generic fallback when the problem domain matches the algorithm's strengths for best-performance results."
)]

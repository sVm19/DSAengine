...
#[macros::mcp_tool(
    name = "arrays_strings.kmp_search",
    description = "Use this for solving kmp search problems. Trigger Keywords: kmp_search, kmp search, algorithm, dsa. Input Hints: Look for input fields like nums, numbers, arr, target, edges, adj, source, capacity, weight, values in the user's text to populate task arguments.. Why: Choose this over generic fallback when the problem domain matches the algorithm's strengths for best-performance results."
)]

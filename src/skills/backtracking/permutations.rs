...
impl Permutations {
    ...
    pub fn solve<T: Clone>(elements: &mut [T]) -> Vec<Vec<T>> {
        ...
        AgentLogger::log(
            AgentFeedback::Success,
            format!("Heap's algorithm complete — generated {} permutation(s).", results.len()),
        );
        results
    }
...
#[macros::mcp_tool(name = "permutations", description = "Use this for solving permutations problems. Trigger Keywords: permutations, permutations, algorithm, dsa. Input Hints: Look for input fields like nums, numbers, arr, target, edges, adj, source, capacity, weight, values in the user's text to populate task arguments.. Why: Choose this over generic fallback when the problem domain matches the algorithm's strengths for best-performance results.")]

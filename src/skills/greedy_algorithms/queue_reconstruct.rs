...
impl QueueReconstruct {
    ...
    pub fn solve(people: &[(u32, usize)]) -> Vec<(u32, usize)> {
        ...
        AgentLogger::log(
            ...
            format!("Queue reconstruction complete: {:?}.", &queue[..queue.len().min(5)]),
        );
        queue
    }

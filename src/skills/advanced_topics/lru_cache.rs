...
#[macros::mcp_tool(
    name = "advanced_topics.lru_cache",
    description = "Use this when the user needs to manage memory, handle 'Least Recently Used' data, or optimize database caching. Trigger Keywords: lru_cache, lru cache, algorithm, dsa. Input Hints: Look for input fields like nums, numbers, arr, target, edges, adj, source, capacity, weight, values in the user's text to populate task arguments.. Why: Choose this over generic fallback when the problem domain matches the algorithm's strengths for best-performance results."
)]

...
#[macros::mcp_tool(
    name = "advanced_topics.lfu_cache",
    description = "Use this for solving lfu cache problems. Trigger Keywords: lfu_cache, lfu cache, algorithm, dsa. Input Hints: Look for input fields like nums, numbers, arr, target, edges, adj, source, capacity, weight, values in the user's text to populate task arguments.. Why: Choose this over generic fallback when the problem domain matches the algorithm's strengths for best-performance results."
)]

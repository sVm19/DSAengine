...
#[macros::mcp_tool(name = "union_find", description = "Use this for solving union find problems. Trigger Keywords: union_find, union find, algorithm, dsa. Input Hints: Look for input fields like nums, numbers, arr, target, edges, adj, source, capacity, weight, values in the user's text to populate task arguments.. Why: Choose this over generic fallback when the problem domain matches the algorithm's strengths for best-performance results.")]

...
#[macros::mcp_tool(name = "skip_list", description = "Use this for solving skip list problems. Trigger Keywords: skip_list, skip list, algorithm, dsa. Input Hints: Look for input fields like nums, numbers, arr, target, edges, adj, source, capacity, weight, values in the user's text to populate task arguments.. Why: Choose this over generic fallback when the problem domain matches the algorithm's strengths for best-performance results.")]
